...
O tipo de banco de dados que é oferecido pelo serviço e a versão do banco de dados que seu serviço usa. Se uma versão de banco de dados mais recente estiver disponível, uma notificação será exibida, junto a um link para a seção [Fazer upgrade da versão](/docs/services/ComposeForPostgreSQL/dashboard-settings.html#upgrade-version) de seu painel de serviço.
...
É possível gerenciar o serviço {{site.data.keyword.composeForPostgreSQL}} por meio da API do {{site.data.keyword.cloud_notm}} Compose.
