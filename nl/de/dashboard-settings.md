...
Mit diesen Funktionen können Sie Ihren {{site.data.keyword.composeForPostgreSQL_full}}-Service besser an Ihre Bedürfnisse und Anforderungen anpassen.
...
![Versionsanzeige](./images/postgres-version-show.png "Versionsanzeige")
...
2. Klicken Sie in der Anzeige _Bereitstellungsdetails_ auf **Ressourcen skalieren**. Die Seite 'Ressourcen skalieren' wird geöffnet.
    ...
    ![Seite 'Ressourcen skalieren'](./images/postgres-scale-show.png "Seite 'Ressourcen skalieren'")

3. Passen Sie den Schieberegler an, um den Speicher zu erhöhen oder zu verringern, der dem {{site.data.keyword.composeForPostgreSQL}}-Service zugeordnet ist. Verschieben Sie den Schieberegler nach links, um den Speicherplatz zu verringern, oder nach rechts, um ihn zu erhöhen.
...
![Kennwort für PostgreSQL aktualisieren](./images/postgres-update-password.png "Automatischer Kennwortgenerator")
...
![IP-Adressen auf Whitelist setzen](./images/postgres-whitelist-show.png "Felder der Whitelist.")
