...
![Update password job running](./images/postgres-update-password-running.png "The Deployment Details pane, showing one running job: Change PostgreSQL password running")
